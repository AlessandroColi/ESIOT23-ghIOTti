...
#define FRAME_SYNC_INDEX 0 // frame sync delay is the first entry in the channel ServoArray
...
#define DELAY_ADJUST 8 // number of microseconds of calculation overhead to subtract from pulse width updates
...
uint8_t ChannelCount = 0; // counter holding the number of attached servos
static boolean isStarted = false; // flag to indicate if the ISR has been initialized
